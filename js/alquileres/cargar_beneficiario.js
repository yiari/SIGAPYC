                ...
                if(json.Items.length > 0){
                    ...
                    if(json.Items[0].length > 0){
                       ...
                       // if (isEmpty(json.Items[0][i]) == false) {
                            ...
                            html += '<a title="Bitacora" href="index.php?url=app/vistas/alquileres/verbeneficiario&idbene=' + json.Items[0][i].id_bene  + '&codbene=' + json.Items[0][i].codigo  + '&codtip=' + json.Items[0][i].tipo  + '&idpro=' + json.Items[0][i].id_prop  + '&codpro=' + json.Items[0][i].propietario +'"><i class="fa fa-book"></i></a>&nbsp;';
