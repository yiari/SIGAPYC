function inicio(){
    ...
    /*
       ...
       */
       ...
       let idinmueble  = getParameterByName('idunid');
       let codigoInmueble = getParameterByName('codinmu');
      

       consultarBitacoraUnidad(idinmueble,codigoInmueble);
   ...
   function imprimirDocumento(prmIdinmu, prmCodinmu){
    ...
    //if (isEmpty(prmDato) == false ){
        ...
        if(prmIdinmu != 0 && prmIdinmu != ""){
            html='app/reportes/repfichaunidad.php?idunid=' + prmIdinmu  + '&codinmu=' + prmCodinmu ;
   ...
   function consultarBitacoraUnidad(id,codigo,tipo){
                ...
                let idinquilino = 0;
                    ...
                    if(json.error == 0){
                        ...
                        if(json.Items.length > 0){
                            ...
                            $('#hidinmuebles').val(json.Items[0].id_unid);
