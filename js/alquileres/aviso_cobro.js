                ...
                if(json.Items.length > 0){
                    ...
                    if(json.Items[0].length > 0){
                            ...
                            // if (isEmpty(json.Items[0][i]) == false) {
                                    ...
                                    html += '<a title="imprimir"  data-field-id="'  + json.Items[0][i].id + '"><i class="fa fa-file-pdf-o" alt=“PDF”></i></a>';
                                    html += '<a title="imprimir"  data-field-id="'  + json.Items[0][i].id + '"><i class="fa fa-file-excel-o " alt=“Execel”></i></a>';
