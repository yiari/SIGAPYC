                    ...
                    if(json.Items[0].length > 0){
                        $("#datosAvisoCobro > tbody").html("");
                            ...
                            // if (isEmpty(json.Items[0][i]) == false) {
                                    ...
                                    html += '<a title="Gastos_especilaes"  href="index.php?url=app/vistas/alquileres/gastos_especiales&idaviso=' + json.Items[0][i].id_aviso + '&codaviso=' + json.Items[0][i].codigo  + '&idinqu=' + json.Items[0][i].id_inqu  + '&codinqu=' + json.Items[0][i].inquilino  +  '&tipoinqu=' + json.Items[0][i].tipo  + '&monto=' + json.Items[0][i].total +  '&idinqu=' + json.Items[0][i].id_inqu  +   '&idinmu=' + json.Items[0][i].id_inmu  +   '&codinmu=' + json.Items[0][i].inmueble  +   '&idunid=' + json.Items[0][i].id_unid  +   '&codunid=' + json.Items[0][i].unidad  + '&mes=' + json.Items[0][i].mes  +'"><i class="fa fa-money"></i></a>';
