...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-04-2022 a las 01:03:18
...
--
ALTER TABLE `banco`
  MODIFY `id_dato` int(10) NOT NULL AUTO_INCREMENT COMMENT 'id dato';

--
-- AUTO_INCREMENT de la tabla `banco_extranjero`
--
ALTER TABLE `banco_extranjero`
...
--
ALTER TABLE `datos_bancarios`
  MODIFY `id_dato` int(10) NOT NULL AUTO_INCREMENT COMMENT 'id del propietario';
...
--
-- AUTO_INCREMENT de la tabla `propietario_juridico`
--
ALTER TABLE `propietario_juridico`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;
