...
--
-- Servidor: localhost
-- Tiempo de generación: 20-04-2022 a las 04:35:10
...
--
ALTER TABLE `banco`
  MODIFY `id_dato` int(10) NOT NULL AUTO_INCREMENT COMMENT 'id dato', AUTO_INCREMENT=18;
--
-- AUTO_INCREMENT de la tabla `datos_bancarios`
--
ALTER TABLE `datos_bancarios`
  MODIFY `id_dato` int(10) NOT NULL AUTO_INCREMENT COMMENT 'id del propietario', AUTO_INCREMENT=20;
--
...
--
ALTER TABLE `pago_movil`
  MODIFY `id_dato` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
--
...
--
ALTER TABLE `zelle`
  MODIFY `id_dato` int(10) NOT NULL AUTO_INCREMENT COMMENT 'id dato - telefono', AUTO_INCREMENT=12;
