...
--
-- Servidor: localhost
-- Tiempo de generación: 18-04-2022 a las 01:42:31
...
(1, '01051234567890123456', 'mercantil');
...
(2, '19621445', 'Venezuela', '04144011233');
...
--
ALTER TABLE `banco`
  MODIFY `id_dato` int(10) NOT NULL AUTO_INCREMENT COMMENT 'id dato', AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT de la tabla `datos_bancarios`
--
ALTER TABLE `datos_bancarios`
  MODIFY `id_dato` int(10) NOT NULL AUTO_INCREMENT COMMENT 'id del propietario', AUTO_INCREMENT=3;
--
...
--
ALTER TABLE `pago_movil`
  MODIFY `id_dato` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
