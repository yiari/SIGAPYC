...
--
-- Servidor: localhost
-- Tiempo de generación: 28-05-2022 a las 23:42:48
...
CREATE TABLE `contrato` (
  `cod_cont` varchar(10) COLLATE utf8_spanish_ci NOT NULL COMMENT 'Codigo',
  `cod_inqu` varchar(10) COLLATE utf8_spanish_ci NOT NULL COMMENT 'inquillino',
  `cod_inmu` varchar(10) COLLATE utf8_spanish_ci  NOT NULL COMMENT 'Inmueble',
  `can_cont` decimal(10,2) COLLATE utf8_spanish_ci  NOT NULL COMMENT 'cannpn de arrendaineto',
  `fec_desd` date COLLATE utf8_spanish_ci  NOT NULL COMMENT 'Inicio de contrato',
  `fec_hast` date COLLATE utf8_spanish_ci  NOT NULL COMMENT 'Fin de Contrato',
  `per_pror` varchar(12) COLLATE utf8_spanish_ci  NOT NULL COMMENT 'periono de prorroga',
  `dia_pago` int(11) COLLATE utf8_spanish_ci  NOT NULL COMMENT 'dia de pago',
  `pas_cont` date COLLATE utf8_spanish_ci  NOT NULL COMMENT 'a partir de',
  `ins_cont` int(11) COLLATE utf8_spanish_ci  NOT NULL COMMENT 'inspeccion de contrato',
  `fec_cont` date COLLATE utf8_spanish_ci  NOT NULL COMMENT 'fec contrato',
  `adm_inmu` decimal(10,2)  COLLATE utf8_spanish_ci NOT NULL COMMENT 'gastos admin',
  `pap_inmu` decimal(10,2)  COLLATE utf8_spanish_ci NOT NULL COMMENT 'gastos inmueble',
  `iva_inmu` decimal(10,2)  COLLATE utf8_spanish_ci NOT NULL COMMENT 'IVA',
  `imp_inmu` decimal(10,2)  COLLATE utf8_spanish_ci NOT NULL COMMENT 'ISLR',
  `dep_cont` decimal(10,2) COLLATE utf8_spanish_ci  NOT NULL COMMENT 'DEposito',
  `com_cont` decimal(10,2)  COLLATE utf8_spanish_ci NOT NULL COMMENT 'Comision',
  `hab_cont` varchar(15)  COLLATE utf8_spanish_ci NOT NULL COMMENT 'Derecho hab',
  `for_cont` varchar(15)  COLLATE utf8_spanish_ci NOT NULL COMMENT 'Forma pago',
  `por_rete` decimal(10,2)  COLLATE utf8_spanish_ci NOT NULL,
  `ret_cont` varchar(15)  COLLATE utf8_spanish_ci NOT NULL,
  `doc_cont` longtext  COLLATE utf8_spanish_ci NOT NULL,
  `act_cont` tinyint(4) COLLATE utf8_spanish_ci  NOT NULL COMMENT '1-Disponible 0-desactivado'
...
INSERT INTO `inmuebles` (`id_inmu`, `id_prop`, `por_part`, `tip_inmu`, `act_inmu`, `ant_inmu`, `img_inmu`, `cod_esta`, `cod_muni`, `cod_parr`, `dir_inmu`, `pun_inmu`, `mtr_inmu`, `mtr_cons`, `hab_inmu`, `ban_inmu`, `est_inmu`, `ser_inmu`, `sta_inmu`, `let_inmu`, `lim_nort`, `lim_sur`, `lim_este`, `lim_oest`, `nom_regi`, `fec_regi`, `tom_regi`, `fol_regi`, `asi_regi`, `fic_cata`, `num_regi`) VALUES
('I-00000001', 'P-00000001', '12', 'LC', 'Comercial', '11', 'archivos/foto_I-00000001.', '01', '88', '22', 'Cale 57', 'frente ', '12.00', '0.00', 12, 2, 2, 12, 1, 'AVA-69', 'Rita Colmenarez', 'Deyanira López', 'Pedro Gomez', 'Calle 57A que es su frente', 'Registro primero', '2016-10-12', '3', '56', '56', 'A9998.09099-99999', '45'),
('I-00000002', 'P-00000001', '1', 'AP', 'Vivienda', '1', 'archivos/foto_I-00000002.', '1', '', '', 'Cale 57', '12', '0.00', '0.00', 0, 0, 0, 0, 1, '', '', '', '', '', '', '0000-00-00', '', '', '', '', ''),
('I-00000003', 'P-00000001', '', 'CA', '', '1', 'archivos/foto_I-00000003tmp', '', '', '', '', '', '0.00', '0.00', 0, 0, 0, 0, 1, '', '', '', '', '', '', '0000-00-00', '', '', '', '', ''),
('I-00000004', 'P-00000001', '', 'ED', '', '', 'archivos/foto_I-00000004jpg', '', '', '', '', '', '0.00', '0.00', 0, 0, 0, 0, 1, '', '', '', '', '', '', '0000-00-00', '', '', '', '', '');
