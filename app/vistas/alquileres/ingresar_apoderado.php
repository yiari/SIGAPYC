    ...
    <div class="container">
        ...
        <div class="card-header">
                    ...
                    <div style="text-align: right;">
                        <ol>          
                            <a class="btn btn-outline-secondary codpro atrasURL" href="index.php?url=app/vistas/alquileres/apoderado"  role="button">Atras</a>
                        </ol>
                    </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form class="form-sample" id="registrarapoderado" name="registrarapoderado" method="POST" action="" autocomplete="off" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                               ...
                                               <div class="col-md-3">
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    <div class="col-sm-12">
                                                        <input type="text" class="form-control" id="num_pode" name="num_pode" maxlength="11"><br>
                                                    </div>
                                                </div>
                                                <div class="col-md-2">
                                                    <label for="tom_pode" class="col-sm-9 col-form-label">Tomo:</label>
                                                    <div class="col-sm-12">
                                                        <input type="text" class="form-control" id="tom_pode" name="tom_pode" maxlength="11"><br>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <label for="fol_pode" class="col-sm-9 col-form-label">Folio o asiento real:</label>
                                                    <div class="col-sm-12">
                                                        <input type="text" class="form-control" id="fol_pode" name="fol_pode" maxlength="11"><br>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <label for="ponot_docu" class="col-sm-9 col-form-label">Poder Notariado</label>
                                                    <div class="col-sm-12">
                                                        <input class="form-control form-control-sm" id="ponot_docu" type="file" name="ponot_docu">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <input class="form-control form-control-sm" id="refper_docu2" type="file" name="refper_docu2" >
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <input class="form-control form-control-sm" id="reffam_docu2" type="file" name="reffam_docu2" >
