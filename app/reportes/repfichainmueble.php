...
if(isset($_GET["idinmu"])) {
  
    $idinmu_temp = $_GET["idinmu"];
}
...
try {
    ...
    $stmt = $dbConexion->conectar()->prepare("CALL usp_vermandato(?)" );
...
try {
    ...
    $stmt = $dbConexion->conectar()->prepare("CALL usp_verinquiliinmueble(?)" );
    $stmt ->bindParam(1, $idinmu_temp, PDO::PARAM_INT);
    //$stmt ->bindParam(2, $codinmu_temp, PDO::PARAM_INT);
...
*/
    ...
    */
    ...
    $pdf->SetTextColor($fontColorContenido['r'], $fontColorContenido['g'], $fontColorContenido['b']);
    $pdf->SetFillColor(2, 157, 116); //Fondo verde de celda
    $pdf->SetXY(122,66);//AQUI SE AJUSTA LA POSICION DONDE SE DEBE COLOCAR EL TEXTO
    //Atención!! el parámetro true rellena la celda con el color elegido
    ...
    $pdf->SetTextColor($fontColorContenido['r'], $fontColorContenido['g'], $fontColorContenido['b']);
    $pdf->SetFillColor(2, 157, 116); //Fondo verde de celda
    $pdf->SetXY(30,71);//AQUI SE AJUSTA LA POSICION DONDE SE DEBE COLOCAR EL TEXTO
    //Atención!! el parámetro true rellena la celda con el color elegido
    ...
    $pdf->SetTextColor($fontColorContenido['r'], $fontColorContenido['g'], $fontColorContenido['b']);
    $pdf->SetFillColor(2, 157, 116); //Fondo verde de celda
    $pdf->SetXY(45,90);//AQUI SE AJUSTA LA POSICION DONDE SE DEBE COLOCAR EL TEXTO
    //Atención!! el parámetro true rellena la celda con el color elegido
