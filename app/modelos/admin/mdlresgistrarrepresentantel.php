  ...
  $prmMensaje = "";
      ...
      try {
         ...
         /* 
          ...
          |----------------------------------------------------------------------------------
          */
          $stmt = $dbConexion->conectar()->prepare("CALL usp_registrorepre_legal(?,?,?,?,?)");
          $stmt -> bindParam(1, $datos["id_legal"], PDO::PARAM_INT);
          $stmt -> bindParam(2, $datos["nom_legal"], PDO::PARAM_STR);
          $stmt -> bindParam(3, $datos["ape_legal"], PDO::PARAM_STR);
          $stmt -> bindParam(4, $datos["rif_legal"], PDO::PARAM_STR);
          $stmt -> bindParam(5, $datos["ced_legal"], PDO::PARAM_STR);
    ...
    $prmMensaje = "";
        ...
        try {
           ...
           /* 
            ...
            |----------------------------------------------------------------------------------
            */
            $stmt = $dbConexion->conectar()->prepare("CALL usp_eliminarrepresentantes(?)");
            $stmt -> bindParam(1, $datos["idrepresentante"], PDO::PARAM_INT);
      ...
      If($iten == null && $valor == null){
            ...
            try {
              ...
              $dbConexion = new conexcion();  
                ...
                $stmt = $dbConexion->conectar()->prepare("SELECT id_legal,nom_legal,ape_legal,rif_legal,ced_legal FROM $tabla WHERE activo = 1");
                $stmt->execute();
        ...
        try {
          ...
          $stmt = $dbConexion->conectar()->prepare("SELECT id_legal, nom_legal,ape_legal,rif_legal,ced_legal FROM $tabla WHERE $iten = :$iten");
